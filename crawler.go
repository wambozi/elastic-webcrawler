...
func crawler(elasticClient *elasticsearch.Client, redisClient *redis.Client, events events.EventEmmiter, requestID string, indexName string, logger *logrus.Logger) {
	// TODO:
